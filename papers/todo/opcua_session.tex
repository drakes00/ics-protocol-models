...
%                \declinst{sess}{S}{}
%
%                \mess{\sm{\csreq}{$K_{cli}$}{sk(C)}}{cli}{sess}
%                \nextlevel[1.5]
%
%                \mess{\sm{SSC, $N_{s2}$}{$K_{srv}$}{sk(S)}}{sess}{cli}
%                \nextlevel[1.5]
%                
...
%                \nextlevel[2]
%                
%                \mess{\sm{CSC, Login, Passwd}{$K_{cli}$}{sk(C)}}{cli}{sess}
%                \nextlevel[2]
%                
...
%                \nextlevel[2]
%
%                \mess{\sm{\asres}{$K_{src}$}{sk(S)}}{sess}{cli}
%                \nextlevel[2]
%            \end{msc}
%        \end{postscript}
%    }
    ...
    \resizebox{\textwidth}{!}{
        \begin{postscript}
            \begin{msc}{Session creation}
                ...
                \mess{\sm{\asreq, S, pk(C), Login, Passwd}{$K_{cli}$}{sk(C)}}{cli}{sess}
                \nextlevel[1]
