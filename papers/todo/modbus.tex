    ...
    \resizebox{.75\textwidth}{!}{
        \begin{postscript}
            \begin{msc}{\modbus}
                ...
                \mess{\sm{Header$_1$, Fc$_1$, Data$_1$}{}{skC}}[b]{cli}{srv}
                \nextlevel[1.5]

                \mess{\sm{Header$_2$, Fc$_2$, Data$_2$}{}{skS}}[b]{srv}{cli}
                \nextlevel[1]
            \end{msc}
        \end{postscript}
    }
...
\begin{figure}[htb]
    ...
    \resizebox{.8\textwidth}{!}{
        \begin{postscript}
            \begin{msc}{\modbus}
                \setlength{\envinstdist}{1.5\envinstdist}
                \setlength{\instdist}{4.5\instdist}

                \declinst{cli}{C}{}
                \declinst{srv}{S}{}

                \mess{\sm{TS$_1$, Header$_1$, Fc$_1$, Data$_1$}{}{skC}}[b]{cli}{srv}
                \nextlevel[1.5]

                \mess{\sm{TS$_2$, Header$_2$, Fc$_2$, Data$_2$}{}{skS}}[b]{srv}{cli}
                \nextlevel[1]
            \end{msc}
        \end{postscript}
    }
    ...
    \resizebox{.8\textwidth}{!}{
        \begin{postscript}
            \begin{msc}{\modbus}
                ...
                \mess{\sm{m$_1$}{}{skC}}[b]{cli}{i1}
                \mess{\sm{m$_2$}{}{skI$_2$}}[b]{i2}{srv}
                \nextlevel[1]
            \end{msc}
        \end{postscript}
    }
