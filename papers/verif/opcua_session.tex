...
\TODO Tags nécessaires pour cette section.
...
\begin{table}[htb]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        \hline
        \smn           & \sms           & \UNSAFE       & \SAFE         & \UNSAFE       \\ 
        \hline
        \smn           & \smseshort     & \UNSAFE       & \SAFE         & \UNSAFE       \\ 
        \hline
        \sms           & \smn           & \UNSAFE       & \UNSAFE       & \SAFE         \\ 
        \hline
        \sms           & \sms           & \UNSAFE       & \UNSAFE       & \UNSAFE       \\ 
        \hline
        \sms           & \smseshort     & \UNSAFE       & \SAFE         & \SAFE         \\ 
        \hline
        \smseshort     & \smn           & \UNSAFE       & \UNSAFE       & \SAFE         \\ 
        \hline         
        \smseshort     & \sms           & \UNSAFE       & \UNSAFE       & \SAFE         \\ 
        \hline         
...
\begin{table}[htb]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        C              & S              & Sec $Creds$   & Auth $Creds$  & Auth $N_S$    \\
        \hline                                                                          
        \smn           & \smn           & \UNSAFE       & \SAFE         & \SAFE         \\ 
        \hline
        \smn           & \sms           & \UNSAFE       & \SAFE         & \SAFE         \\ 
        \hline
        \smn           & \smseshort     & \UNSAFE       & \SAFE         & \SAFE         \\ 
        \hline
        \sms           & \smn           & \SAFE         & \SAFE         & \SAFE         \\ 
        \hline
        \sms           & \sms           & \UNSAFE       & \SAFE         & \SAFE         \\ 
        \hline
        \sms           & \smseshort     & \SAFE         & \SAFE         & \SAFE         \\ 
        \hline
        \smseshort     & \smn           & \SAFE         & \SAFE         & \SAFE         \\ 
        \hline         
