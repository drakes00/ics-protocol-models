...
\newcommand{\dosmhmacencrypt}[3]{$\left\{\mbox{#1}\right\}_{\mbox{#2}}$, HMAC(\mbox{#3}, (\mbox{#1}))}
...
\newpage
\section{\opcua OpenSecureChannel RSA}\label{sec:secure_channel_rsa}
\input{opcua_secure_channel_rsa}

\newpage
\section{\opcua CreateSession RSA}\label{sec:session_rsa}
\input{opcua_session_rsa}
