...
\begin{itemize}
    \item {\em \smse}: claims to provide secrecy using symetric and
...
\cite{MLD09} that ``\emph{The establishement of the Secure Channel is
  mainly used for exchanging special secret information between
  clients and servers. This secret is used for deriving Symetric Keys
