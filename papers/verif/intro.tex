...
OpenSecureChannel and \opcua CreateSession.
We are able to find attacks against both of them and provide countermeasure when
needed.
...
\paragraph{Outline:} In the next section
%we study the security of  MODBUS.
%In Section~\ref{sec:opcua},
we analyse the security of OPC-UA, before concluding
in last section.
